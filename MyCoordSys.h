...
double MyCoordSys :: MyX (double x)
    {
    return x*scaleX + pos.x;
    }

//=============================================================================

double MyCoordSys :: MyY (double y)
    {
    return -(y*scaleY) + size.y + pos.y;
    }

//=============================================================================

void MyCoordSys :: Circle (double  x,  double y, double r)
    {
    if (PointVisible (x, y)) txCircle (MyX (x), MyY (y), r);
    }

//=============================================================================

void MyCoordSys :: Pixel (double  x,  double y, COLORREF color)
    {
...
void MyCoordSys :: Rectangle (double x0, double y0, double x1, double y1)
    {
...
void MyCoordSys :: Line (double x0, double y0, double x1, double y1)
    {
...
void MyCoordSys :: TextOut (double  x,  double y, const char text[])
    {
...
bool MyCoordSys :: PointVisible (double x, double y)
    {
